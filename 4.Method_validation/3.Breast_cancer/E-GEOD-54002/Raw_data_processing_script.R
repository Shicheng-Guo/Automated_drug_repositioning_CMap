...
# DATE: 22/02/2018
# ARRAY EXPRESS NUMBER: E-GEOD-54002
...
#
# NOTES - 
# script modified as all females
#
...
work_dir="/media/hamel/Workspace/Dropbox/Projects/CMap/1.Data/Validation_datasets/Breast_Cancer/E-GEOD-54002"
...
#raw data only - https
data_raw=https_getAE("E-GEOD-54002", type = "raw")

#raw data only
#data_raw=getAE("E-GEOD-54002", type = "raw")

#processed data only
#data_raw=getAE("E-GEOD-54002", type = "processed")

#all data
#data_raw=getAE("E-GEOD-54002", type = "full")
...
Tissue<-phenotype_data[7]
colnames(Tissue)<-"Tissue"

Age<-phenotype_data[1]
colnames(Age)<-"Age"

Diagnosis<-phenotype_data[37]
...
Diagnosis[grep("breast cancer", Diagnosis[,1]),]<-"case"
table(Diagnosis)
...
expression_data_background_corrected<-gcrma(expression_data)
