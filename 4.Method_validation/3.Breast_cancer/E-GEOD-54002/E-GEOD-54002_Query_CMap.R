...
# working directory
work_dir="/media/hamel/Workspace/Dropbox/Projects/CMap2/4.Method_validation/3.Breast cancer/E-GEOD-54002/"

# directory of DE results of disease
data_dir="/media/hamel/Workspace/Dropbox/Projects/CMap/1.Data/Validation_datasets/Breast_Cancer/E-GEOD-54002/DE_results/"
...
disease_DE<--read.table("Full_Differential_Expression_Results.txt")
...
#apply function
method3_results<-run_method3(disease_DE, 8)
