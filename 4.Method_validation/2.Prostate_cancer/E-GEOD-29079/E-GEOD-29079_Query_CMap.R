...
# working directory
work_dir="/media/hamel/Workspace/Dropbox/Projects/CMap2/4.Method_validation/2.Prostate_cancer/E-GEOD-29079/"

# directory of DE results of disease
data_dir="/media/hamel/Workspace/Dropbox/Projects/CMap/1.Data/Validation_datasets/Prostate_Cancer/DE_results/"
...
#apply function
method3_results<-run_method3(disease_DE, 30)
